...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{figure/airgap_flux_density_no_load.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{figure/flux_linkage_no_load.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{figure/back_emf_no_load.pdf}
    \caption{Back EMF}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{figure/cogging.pdf}
    \caption{cogging}
...
\begin{figure}[htbp]  
    \centering
    \includegraphics[width=0.45\textwidth]{figure/axial_force_no_load.pdf}
    \caption{Axial Force}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{figure/airgap_flux_density.pdf}
    \caption{Mật độ từ thông khe hở không khí}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{figure/flux_linkage.pdf}
    \caption{Flux Linkage}
    \label{flux_linkage}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{figure/back_emf.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{figure/torque.pdf}
    \caption{Momen}
    \label{torque}
\end{figure}
